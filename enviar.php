...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $mailer->Port = 587; // Porta de conexão SMTP (Titan Mail usa STARTTLS na porta 587)
    $mailer->Host = 'smtp.titan.email'; // Host SMTP do Titan Mail
    $mailer->SMTPAuth = true; // Habilita autenticação SMTP
    $mailer->Username = 'contato@mparmlog.com.br'; // Login SMTP (seu endereço de e-mail Titan)
    $mailer->Password = 'yJUp-i5_DSP3cXw'; // Senha SMTP (substitua pela senha correta)
